...
public class MerchantDomainServiceTests {
    ...
    public async Task MerchantDomainService_CreateMerchant_MerchantIsCreated(
        ...
        MerchantCommands.CreateMerchantCommand command = new(TestData.EstateId, TestData.CreateMerchantRequest);
    ...
    public async Task MerchantDomainService_UpdateMerchant_MerchantIsUpdated(
        ...
        MerchantCommands.UpdateMerchantCommand command = new(TestData.EstateId, TestData.MerchantId,
            TestData.UpdateMerchantRequest);
