...
namespace EstateManagement.MerchantDepositListAggregate.Tests
{
    ...
    public class MerchantDepositListAggregateTests
    {
        ...
        public void MerchantDepositListAggregate_MakeDeposit_TwoDeposits_BothDepositsMade()
        {
            ...
            merchantDepositListAggregate.MakeDeposit(TestData.MerchantDepositSourceManual, TestData.DepositReference, TestData.DepositDateTime, TestData.DepositAmount);
            merchantDepositListAggregate.MakeDeposit(TestData.MerchantDepositSourceManual, TestData.DepositReference2, TestData.DepositDateTime2, TestData.DepositAmount2);
        ...
        public void MerchantDepositListAggregate_MakeDeposit_TwoDepositsSameDetailsApartFromAmounts_BothDepositsMade()
        {
            ...
            merchantDepositListAggregate.MakeDeposit(TestData.MerchantDepositSourceManual, "Test Data Gen Deposit", new DateTime(2021, 1, 1, 0, 0, 0), PositiveMoney.Create(Money.Create(650.00m)));
            merchantDepositListAggregate.MakeDeposit(TestData.MerchantDepositSourceManual, "Test Data Gen Deposit", new DateTime(2021, 1, 1, 0, 0, 0), PositiveMoney.Create(Money.Create(934.00m)));
        ...
        public void MerchantDepositListAggregate_MakeDeposit_TwoDepositsOneMonthApartSameDetails_BothDepositsMade()
        {
            ...
            merchantDepositListAggregate.MakeDeposit(TestData.MerchantDepositSourceManual, "Test Data Gen Deposit", new DateTime(2021, 1, 1, 0, 0, 0), PositiveMoney.Create(Money.Create(650.00m)));
            merchantDepositListAggregate.MakeDeposit(TestData.MerchantDepositSourceManual, "Test Data Gen Deposit", new DateTime(2021, 2, 1, 0, 0, 0), PositiveMoney.Create(Money.Create(650.00m)));
        ...
        public void MerchantDepositListAggregate_MakeDeposit_DepositSourceNotSet_ErrorThrown()
        {
            ...
            Should.Throw<InvalidOperationException>(() =>
            {
                merchantDepositListAggregate.MakeDeposit(MerchantDepositSource.NotSet, TestData.DepositReference, TestData.DepositDateTime, TestData.DepositAmount);
            });
        }
        ...
        public void MerchantDepositListAggregate_MakeDeposit_AutomaticDepositSource_DepositMade()
        {
            ...
            merchantDepositListAggregate.MakeDeposit(TestData.MerchantDepositSourceAutomatic, TestData.DepositReference, TestData.DepositDateTime, TestData.DepositAmount);
